...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerInfix(token.INEQUAL, p.parseInfixExpression)
...
func (p *Parser) parseCallExpression(function ast.Expression) ast.Expression {
	...
	exp.Arguments = p.parseCallAgruments()
	return exp
}

func (p *Parser) parseCallAgruments() []ast.Expression {
